...
from core.apis.assignments import student_assignments_resources, teacher_assignments_resources,principal__assignments_resources
...
app.register_blueprint(principal__assignments_resources, url_prefix='/principal')
